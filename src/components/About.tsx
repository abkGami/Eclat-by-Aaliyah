    ...
    <section id="about" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-800 mb-4">About Glamour Glow</h2>
          <div className="w-20 h-1 bg-pink-400 mx-auto"></div>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-serif font-bold text-gray-800 mb-6">Our Story</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Founded in 2018, Glamour Glow began with a passion for bringing out each individual's natural beauty. 
              Our team of professional makeup artists is dedicated to creating looks that enhance your features 
              while ensuring you still feel like yourself.
            </p>
            <p className="text-gray-600 mb-6 leading-relaxed">
              We believe makeup should be an expression of your unique style and personality. 
              Whether you're preparing for your wedding day, a special event, or a professional photoshoot, 
              we create custom looks that complement your natural features and make you feel confident.
            </p>
